...
import { getAdminCategory,deleteAdminCategory } from "../../services/apiService";
...
function AdminCategoryData() {
    ...
    },
    {
        ...
        renderCell: (params) => (
          <Box
            ...
            alt="category image"
            sx={{ width: 50, height: 50, objectFit: 'cover', borderRadius: '5px' }}
          />
        ),
      },
    {
  ...
  const handleEdit = (id) => {
    ...
    navigate('/admin/update_category/'+id);
  };
  ...
  const addRecord = () => {
    navigate('/admin/create_category');
  };
